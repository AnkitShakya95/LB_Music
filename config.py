...
API_ID = int(getenv("22100695", None))
API_HASH = getenv("0e8f93300ccbbcd56066e6d790b0d3b2", None)
...
LOGGER_ID = int(getenv("1002428139519", None))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", None))

# Get this value Telegram id
OWNER_ID = int(getenv("OWNER_ID", "7441472352"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AnkitShakya95/LB_Music",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/medico_ankitshakya")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Ankit_Music_bot73")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://envs.sh/0lS.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://envs.sh/0l0.jpg"
)
